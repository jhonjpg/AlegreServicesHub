...
const Home = () => {
  ...
  function handleMouseMove(event) {
    ...
    const yRotatio = (
      (clientX - width / 2) / width) * 5;

    const xRotatio = (

      (clientY - height / 2) / height) * 2;
          ...
          {/* <div className="us">
            ...
            <div className=" w-100 d-flex h-50   ">
              ...
              <div className="us-right-text">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Unde quas voluptatum ut provident doloremque omnis, vitae optio eum a culpa deleniti laborum aliquam mollitia voluptatem nulla repudiandae est sit molestiae. Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur veniam cumque necessitatibus aperiam perspiciatis, accusantium aut, nobis iste ducimus animi a tenetur temporibus deserunt aliquam commodi quaerat unde quibusdam dolorem.</p>
...
<div className="w-25"><hr className="w-100 p-2 rounded-pill bg-secondary" />
          ...
          <pre href="w-100 text-warning fs-1">Contactanos</pre>
...
<div className="container d-flex w-25 justify-content-center align-items-center">
    <div className="box d-flex  justify-content-center align-items-center">
        <span className="title"> Horarios de apertura </span>
        <div>
...
<h2>3</h2>
  ...
  <pre href="w-100 fs-1">Contactanos</pre>
